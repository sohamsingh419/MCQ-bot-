...
class Settings(BaseSettings):
    ...
    ai_api_key: str | None = Field(default=None, alias="AI_API_KEY", min_length=8)
    ...
    ai_seek_api_key: str | None = Field(default=None, alias="AI_SEEK_API_KEY")
    ai_seek_url: str = Field(default="https://ai-seek.thebetter.ai/v4/chat/send", alias="AI_SEEK_URL")
    ai_seek_models: str = Field(
        default="qwen/qwen-coder-32b,google/gemini-2.5-flash-lite",
        alias="AI_SEEK_MODELS",
    )
    ai_seek_app_id: str = Field(default="ai-seek", alias="AI_SEEK_APP_ID")
    ai_seek_device_info: str = Field(default="", alias="AI_SEEK_DEVICE_INFO")
    ...
    validator_require_approval: bool = Field(default=True, alias="VALIDATOR_REQUIRE_APPROVAL")
