...
MORNING_MOTIVATIONS = (
    "नई सुबह नई संभावना लेकर आती है—आज अपने लक्ष्य की ओर एक कदम और बढ़ाइए।",
    "आज का अनुशासन आपकी कल की सफलता को मजबूत बनाएगा।",
    "सुबह की शुरुआत विश्वास से कीजिए, मेहनत रास्ता खुद बना देगी।",
    "हर दिन सीखने का नया अवसर है—आज उसे पूरी लगन से अपनाइए।",
    "आपकी तैयारी का हर मिनट परीक्षा में आत्मविश्वास बनकर लौटेगा।",
    "छोटी-सी निरंतर मेहनत बड़े सपनों को वास्तविकता में बदलती है।",
    "आज खुद को कल से बेहतर बनाने का सबसे अच्छा दिन है।",
    "ज्ञान की ओर बढ़ाया गया कदम कभी व्यर्थ नहीं जाता।",
    "लक्ष्य बड़ा हो तो शुरुआत छोटी हो सकती है, रुकना नहीं।",
    "सुबह का संकल्प: सीखना है, समझना है और आगे बढ़ना है।",
    "आपकी मेहनत आपकी पहचान बनेगी—आज भी पूरी ईमानदारी से पढ़िए।",
    "एक कठिन प्रश्न भी आपकी तैयारी को पहले से मजबूत बना सकता है।",
    "आत्मविश्वास अभ्यास से आता है—आज अभ्यास का एक अवसर और जोड़िए।",
    "सफलता उन्हीं को मिलती है जो हर सुबह फिर से प्रयास शुरू करते हैं।",
)

NIGHT_MOTIVATIONS = (
    "आज आपने जो सीखा, वही कल की सफलता की नींव बनेगा।",
    "दिन का प्रयास छोटा हो या बड़ा, निरंतरता हमेशा जीतती है।",
    "आज की गलतियों से सीखिए और कल और बेहतर तैयारी के साथ लौटिए।",
    "आपने आज अपने लक्ष्य के लिए समय दिया—यह प्रयास महत्वपूर्ण है।",
    "हर हल किया हुआ प्रश्न आपकी मंज़िल को थोड़ा और करीब लाता है।",
    "आराम कीजिए, क्योंकि नई ऊर्जा के साथ कल फिर शानदार शुरुआत करनी है।",
    "धीरे-धीरे आगे बढ़ना भी जीत की दिशा में बढ़ना है।",
    "आज का समर्पण आने वाले परिणामों में अवश्य दिखाई देगा।",
    "अपने प्रयास पर गर्व कीजिए और कल के लिए विश्वास बनाए रखिए।",
    "ज्ञान का सफर एक दिन में पूरा नहीं होता—आप सही दिशा में हैं।",
    "हर रात अपने लक्ष्य को याद कीजिए और हर सुबह उसके लिए काम कीजिए।",
    "आपकी मेहनत कभी खोती नहीं; वह अनुभव और आत्मविश्वास बनती है।",
    "आज का अध्ययन समाप्त हुआ, लेकिन सफलता की यात्रा जारी है।",
    "शुभ रात्रि—कल एक नई सीख और एक नई उपलब्धि आपका इंतज़ार कर रही है।",
)

# Backward-compatible combined catalog for callers that imported the old name.
DAILY_MOTIVATIONS = MORNING_MOTIVATIONS + NIGHT_MOTIVATIONS
...
class SchedulerService:
    ...
    @staticmethod
    def _motivation_for_slot(slot: str, local_date) -> str:
        catalog = NIGHT_MOTIVATIONS if slot == "night" else MORNING_MOTIVATIONS
        return catalog[local_date.toordinal() % len(catalog)]

    @staticmethod
    def _motivation_for_date(local_date) -> str:
        """Backward-compatible alias for the morning catalog."""
        return SchedulerService._motivation_for_slot("morning", local_date)

    @classmethod
    def _routine_message(cls, slot: str, local_date) -> str:
        motivation = cls._motivation_for_slot(slot, local_date)
        if slot == "night":
            return (
                "🌙✨ <b>आज की प्रेरणा</b> ✨🌙\n\n"
                f"<b>“{motivation}”</b>\n"
